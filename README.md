...
## Updated docker image with dind based on **Ubuntu 22.04**.

## How to use it

```
docker run -it --privileged orboan/ubuntu-dind
```

Please note that here I have not take into cosideration env variables, volumes, ports, etc.

Original README.md includes next documentation:
